      ...
      <div className='container'>
        <div>
          <b>
            ...
            <i>
              {dungeonLoca} {locaFlavor.location_flavor_string}
            </i>
            " to seek fortune and excitement! You enter the danger zone! And...
          </b>
          <br />
          <br />
          ...
          You reach the end of the {dungeonLoca}! You find{' '}
          {numberOfEncounters * 10} gold coins!
          <br />
          <br />
