...
export default class Encounter extends Component {
  ...
  render() {
    ...
    const { monsterName, monsterHitpoints, attackName, attackDamageDie, attackDamageType } = this.props
    if (isLoading === true) {
      return 'Loading...'
    }
    ...
    return (
      <div className='encounter'>
        ...
        <br />
        <br />
        You attack a {monsterName} with your{' '}
        {attackName} for{' '}
        {charDamage} {attackDamageType} damage!{' '}
        {`It has ${
          monsterHitpoints - charDamage
        } hitpoints remaining`}
        <br />
        <br />
        The {monsterName} attacks you for{' '}
        {monsterDamage} damage!
        <br />
        <br />
        You attack a {monsterName} with your{' '}
        {attackName} for{' '}
        {charDamage + 50} {attackDamageType} damage!{' '}
        The {monsterName} dies horribly!
        <br />
        <hr />
        <br />
      </div>
